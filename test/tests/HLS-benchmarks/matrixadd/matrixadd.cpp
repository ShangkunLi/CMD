...
in_float_t array_0[M];
in_float_t array_1[M];
in_float_t array_2[M];
// in_float_t array_3[M];
in_float_t array_4[M];
// in_float_t array_5[M];
// in_float_t array_6[M];
// in_float_t array_7[M];

out_float_t matrixadd()
{
  float s_0 = 0.0f;
  float s_1 = 0.0f;
  float s_2 = 0.0f;
