...
void DFGNode::setOptType(string t_optType)
{
  m_optType = t_optType;
}
...
bool DFGNode::getPrecisionAware()
{
  return m_precisionAware;
}

void DFGNode::setPrecisionAware(bool precisionAware)
{
  m_precisionAware = precisionAware;
}
...
void DFGNode::setFuType(string t_fuType)
{
  m_fuType = t_fuType;
}
...
void DFGNode::setCritical(bool critical)
{
  m_critical = critical;
}
...
void DFGNode::initPredicatees()
{
  m_predicatees = NULL;
}

void DFGNode::setIsPredicatee(bool ispredicatee)
{
  m_isPredicatee = ispredicatee;
}
...
void DFGNode::setIsPredicater(bool ispredicater)
{
  m_isPredicater = ispredicater;
}
...
void DFGNode::setMapped(bool Mapped)
{
  m_isMapped = Mapped;
}
...
void DFGNode::setValue(Value *value)
{
  m_value = value;
}
...
void DFGNode::setInst(Instruction *inst)
{
  m_inst = inst;
}
...
void DFGNode::setSringRef(StringRef stringRef)
{
...
void DFGNode::setCombine(bool combined)
{
  m_combined = combined;
}

void DFGNode::initPatternNodes()
{
  m_patternNodes = new list<DFGNode *>();
}
...
void DFGNode::setIsPatternRoot(bool isPatternRoot)
{
  m_isPatternRoot = isPatternRoot;
}
...
void DFGNode::setOpcodeName(string opcodeName)
{
...
void DFGNode::setPipelinable(bool pipelinable)
{
  m_pipelinable = pipelinable;
}
...
void DFGNode::initPredNodes(list<DFGNode *> *predNodes)
{
  m_predNodes = predNodes;
}

void DFGNode::addPredNode(DFGNode *dfgNode)
{
  if (m_predNodes == NULL)
  {
    m_predNodes = new list<DFGNode *>();
  }
  m_predNodes->push_back(dfgNode);
}
...
void DFGNode::initSuccNodes(list<DFGNode *> *succNodes)
{
  m_succNodes = succNodes;
}

void DFGNode::addSuccNode(DFGNode *dfgNode)
{
  if (m_succNodes == NULL)
  {
    m_succNodes = new list<DFGNode *>();
  }
  m_succNodes->push_back(dfgNode);
}
...
void DFGNode::setConst(int numConst)
{
  m_numConst = numConst;
}
